...
out <- image_annotate(image_read("C:/github/fieldreport_panama/content/posts/palacios/images/240.jpg"), txt,
                      gravity = "northwest", color = "red",
                      boxcolor = adjustcolor("black", alpha=0.1),
                      size = 12, location = "+10+10")
image_write(out, "C:/github/fieldreport_panama/content/posts/palacios/images/240.jpg")
...
exif_call(path = "C:/github/fieldreport_panama/content/posts/palacios/images/240.jpg", 
